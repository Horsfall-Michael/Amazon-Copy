...
/*
  ...
  xhr.addEventListener('load', ()=>{
    ...
    xhr.addEvenlistener('error',(error) =>{
      what to do incase of the error
    })
...
export function loadProductsFetch() {
  return fetch('https://supersimplebackend.dev/products')
    ...
    .then((productsData) => {
      ...
      return products; //  return products so tests can use them
    });
}
...
/*
  export const products = [
    ...
    {
      id: "bc2847e9-5323-403f-b7cf-57fde044a955add1",
      image: "images/products/backpack.jpg",
      name: "Unisex Heavy duty backpack",
      rating: {
        stars: 4,
        count: 2157
      },
      ...
      id: "bc2847e9-5323-403f-b7cf-57fde044a955added2",
